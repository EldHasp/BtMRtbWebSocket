...
namespace ViewModel
{
    public partial class ViewModel : OnPropertyChangedClass
    {
        ...
        private void CreateREST(string bitmexKey, string bitmexSecret, bool realWork)
        {
            str = new STR(bitmexKey, bitmexSecret, realWork, BinSizeSelected, CountCandelesForCalculate);
