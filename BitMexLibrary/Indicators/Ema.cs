...
namespace MachinaTrader.Indicators
{
    public static partial class Extensions
    {
        public static List<decimal?> Ema(this List<Candle> source, int period = 30, CandleVariable type = CandleVariable.Close)
        {
            ...
            var ema = TicTacTec.TA.Library.Core.Ema(0, source.Count - 1, valuesToCheck, period, out int outBegIdx, out int outNbElement, emaValues);
        ...
        public static List<decimal?> Ema(this List<decimal> source, int period = 30)
        {
            ...
            var sma = TicTacTec.TA.Library.Core.Ema(0, source.Count - 1, sourceFix, period, out int outBegIdx, out int outNbElement, emaValues);
